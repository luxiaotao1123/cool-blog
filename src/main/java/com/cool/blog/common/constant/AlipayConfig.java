...
public class AlipayConfig {
    ...
    // 同步回调url
    public static final String RETURN_URL = "http://luxiaotao.top:9099/alipay_return_url";

    // 异步回调url
    public static final String NOTIFY_URL = "http://luxiaotao.top:9099/alipay_notify_url";
}
